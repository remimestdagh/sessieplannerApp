...
public class Emailer {
	public void sendPlainTextEmail(String host, String port, final String userName, final String password,String toAddress[], String subject, String message) throws AddressException, MessagingException {
		...
		//e-mail addressen (internetAddressen) opbouwen uit doorgekregen strings met emails
		...
		// message string injecteren in Message object
		msg.setText(message);
		// Verzenden van de effectieve boodschap
		Transport.send(msg);
